    ...
    <div class="min-h-full">
                    ...
                    <div class="px-4 sm:px-6 lg:px-8">
                        <div class="sm:flex sm:items-center">
                            ...
                            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                                <a href="./add_customer.html" type="button"
        ...
        <?php foreach ($customers as $customer): ?>
            <tr>
                ...
                <td class="border px-4 py-2"><?php echo htmlspecialchars($customer['balance']); ?></td>
                <td class="border px-4 py-2"><?php echo htmlspecialchars($customer['is_approved'] ? 'Yes' : 'No'); ?></td>
